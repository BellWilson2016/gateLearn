function optimizeAddDimAscent(subSampleCode, runCode)
	...
	Go = gateFromDimAdd(subSampleCode, '~/gateLearn/FitGates-AscFullHist.mat');
	...
	options = optimoptions(@fmincon, 'Algorithm','sqp',...
							...
							'Display','iter',...
							'DiffMaxChange',.02,'DiffMinChange',.001,...
							'FinDiffRelStep',.01,...
							'TolX',10^-4,...
							'TolFun',10^-6,...
							'TypicalX',ub./2,...
